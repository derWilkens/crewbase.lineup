...
public class TestContainer extends ExternalResource {
    ...
    public TestContainer() {
        ...
        if (StringUtils.isBlank(property)) {
            System.setProperty("logback.configurationFile", "log-conf.xml");
        }
        log = LoggerFactory.getLogger(TestContainer.class);

        springConfig = "test-spring.xml";
        appComponents = Collections.emptyList();
        appPropertiesFiles = Arrays.asList("eu/crewbase/lineup/app.properties", "cuba-app.properties", "test-app.properties", "cuba-test-app.properties");
