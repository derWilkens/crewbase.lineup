...
--
-- Dumping data for table `lineup_airport`
--
-- WHERE:  created_by is not NULL and delete_ts is null

LOCK TABLES `lineup_airport` WRITE;
/*!40000 ALTER TABLE `lineup_airport` DISABLE KEYS */;
/*!40000 ALTER TABLE `lineup_airport` ENABLE KEYS */;
UNLOCK TABLES;
